...
namespace JR.UI.Touch.Bindings
{
	public class FavoritesButtonBinding
		: MvxTargetBinding
	{
		public static readonly UIImage YesImage = UIImage.FromFile("JRResources/star_gold45.png");
		public static readonly UIImage NoImage = UIImage.FromFile("JRResources/star_grey45.png");
