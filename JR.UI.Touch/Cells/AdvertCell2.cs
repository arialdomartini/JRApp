...
namespace JR.UI.Touch
{
	...
	public partial class AdvertCell2 : MvxStandardTableViewCell
	{
		public static NSString Identifier = new NSString("AdvertCell2");
		...
		public static AdvertCell2 LoadFromNib(NSObject owner)
		{
			...
			var views = NSBundle.MainBundle.LoadNib("AdvertCell2", owner, null);
			var cell2 = Runtime.GetNSObject( views.ValueAt(0) ) as AdvertCell2;
			views = null;
			cell2.Initialise();
			return cell2;
		}
		
		public AdvertCell2(IntPtr handle)
		...
		public AdvertCell2 (string bindingText)
			: base(bindingText, MonoTouch.UIKit.UITableViewCellStyle.Default, Identifier)
		{
		}
		...
		{
			Image1.Image = UIImage.FromFile("JRResources/Images/appbar.people.png");
			Image2.Image = UIImage.FromFile("JRResources/Images/appbar.city.png");
		...
		*/
		...
		{
			string imageName = "JRResources/Images/appbar.people.png";
		...
		{
			if (imageName == null) {
				imageName = "JRResources/Images/appbar.people.png";
			}
			...
			slidingImageRect = slidingImageRect;
